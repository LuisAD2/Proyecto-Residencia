...
class Nodo1No2 extends StatefulWidget {
  @override
  _Nodo1No2State createState() => _Nodo1No2State();
}

class _Nodo1No2State extends State<Nodo1No2> {
          ...
          children: [
            Expanded(
              child: SfCartesianChart(
                title: ChartTitle(text: "Comportamiento Dióxido de nitrógeno"),
                legend: Legend(isVisible: true),
                tooltipBehavior: _tooltipBehavior4,
                series: <ChartSeries>[
                  LineSeries<SalesData, double>(
                    name: "Dióxido nitrógeno(NO2)",
                    color: Colors.blue,
